...
class RentPolicy
{
    ...
    {
        return $user->can('delete_any_rent');
    }
     ...
     */
    public function replicate(User $user, Rent $rent): bool
    {
